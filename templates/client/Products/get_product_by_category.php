...
<head>
	...
	<link href="/client_html/https://fonts.googleapis.com/css?family=Noto+Sans+JP&amp;subset=japanese" rel="stylesheet">
	...
	<script async src="http://www.googletagmanager.com/gtag/js?id=UA-122256244-1&amp;l=gtagDataLayer"></script>
	<script>
...
<body class="tempTop template">
	...
	<div id="layer_board_area">
		...
		<div class="layer_board">
			<p><a href="/client_html/https://apps.apple.com/jp/app/beep-sheep-shamp/id1559411993" target="_blank"><img
				...
				<div id="baseMenu">
					<ul class="clearfix">
						<li class="base" style="visibility: hidden;"><a target="_blank" rel="nofollow"
								href="/client_html/https://thebase.in/?from=naughtyboy-base-shop&amp;p=shop"><img
		...
		<header id="mainHeader">
			<div id="headCol">
				...
				<h1><a href="/client_html/../index.html" id="logo"><img class="logoImage"
							src="http://base-ec2if.akamaized.net/w=2048,a=0,q=90,u=0/images/user/logo/f5904431f43d44d07a7a21a716c96da2.png"
					...
					<div id="gnaviCol" class="clearfix">
						<ul class="row">
							...
							<li class="column"><a class="mainHeaderNavColor"
									href="/client_html/https://thebase.in/inquiry/naughtyboy-base-shop">CONTACT</a></li>
						</ul>
					</div>
				</nav>
			</div>
	...
	<div class="container">
		...
		<section id="products">
			...
			<div id="categoryList">
				<!-- カテゴリ名をページの見出しとして表示 -->
				<h3 class="categoryTitle01"><?= $category_parent->name?></h3>
				<!-- 子カテゴリの一覧を表示 -->
				<ul>
				<?php foreach($category_child as $value): ?>
					<li><a href="/client_html/1614111.html"><?= $value->name?></a></li>
					<?php endforeach ?>
			</div>
				...
				<li class="column">
					<a href="">
						<div class="image_container">
							...
							<p class="pht fade">
								<img src="/img/upload/<?= $value->product_details[0]->image?>"
									alt="<?= $value->name?>" title="<?= $value->name?>" class="image-resize" />
							</p>
						</div>
						<div class="item-detail">
							<h2 class="show_on_hover"><?= $value->name?></h2>
							<!---セール価格設定
							<div class="price show_on_hover">¥4,700</div>-->
							<div class="price">¥<?= $value->product_details[0]->price?></div>
							<!---/セール価格設定-->
						</div>
					</a>
				</li>
	...
	<footer id="mainFooter">
		<div class="logoBox">
			<ul>
				<li><a href="/client_html/https://www.17kg.shop/" target="_blank"><img
							src="/client_html/img/shop/logo_17kg.png"
							alt="17kg"></a></li>
				<li class="udresser"><a href="/client_html/https://www.udresser.shop/" target="_blank"><img
							src="/client_html/img/shop/logo_udresser.png"
							alt="udresser"></a></li>
				<li><a href="/client_html/https://www.lilyboutique.tokyo/" target="_blank"><img
							src="/client_html/img/shop/logo_lily.png"
							alt="lily boutique"></a></li>
				<li><a href="/client_html/https://www.belle-17kg.com/" target="_blank"><img
							src="/client_html/img/shop/logo_belle.png"
							alt="belle"></a></li>
				<li class="goodnight5tore"><a href="/client_html/https://goodnight5tore.myshopify.com/" target="_blank"><img
		...
		<ul class="txtList clearfix">
			...
			<li class="boxRight">
				<div class="socialBtnList clearfix">
					<div class="fb sns">
						<div class="fb-like" data-href="/client_html/https://www.beepsheepshamp.com//" data-send="false"
							data-layout="button_count" data-width="200" data-show-faces="false"></div>
					</div>
					<div class="tw sns">
						<a href="/client_html/http://twitter.com/share" class="twitter-share-button"
		...
		<div class="iconBox">
			<ul class="snsBox">
				<li class="twitter"><a href="/client_html/https://twitter.com/beep__official" target="_blank"><img
