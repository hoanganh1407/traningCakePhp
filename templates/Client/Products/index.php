...
<body class="tempTop template">
	...
	<div class="container">
		...
		<div id="banner">
			<div id="bannerCol">
				<ul>
				<?php foreach($categories as $category_parent):?>
					<?php if($category_parent->parent_id == null) :?>
            <li><a href="/client/get_product_by_id/<?= $category_parent->id ?>"><img
		...
		<div id="categories">
			...
			<?php foreach($categories as $category_parent):?>
				<?php if($category_parent->name == 'mens'||$category_parent->name == 'ladies'):?>
            ...
            <div class="<?=$category_parent->name?>">
				...
				<?php foreach($categories as $category):?>
					<?php if($category->parent_id == $category_parent->id) :?>
                            <li><a href="/client/get_product_by_id/<?= $category->id ?>" class="fade"><img
                           ...
                           html += `<li class="column">
                                        <a href="/client/product_detail/${obj.id}">
                                            <div class="image_container">
                                                ...
                                                <p class="pht fade">
                                                    <img src="/img/upload/${obj.product_details[0].image}"
