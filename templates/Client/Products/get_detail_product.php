                    ...
                    <div class="bx-wrapper" style="max-width: 100%;">
                        <div class="bx-viewport"
                            ...
                            <ul class="bxslider" style="width: auto; position: relative;">
                                ...
                                <?php foreach($product->product_details as $value): ?>
                                <li
                                    ...
                                    <div class="img_box">
                                        <a href=""
                                            ...
                                            <img src="/img/upload/<?= $value->image ?>"
                                                alt="" title="">
                                        </a>
                                    </div>
                                </li>
                    ...
                    <div id="bx-pager">
                        ...
                        <a data-slide-index="0" href="/client_html/" class="">
                            <div class="small_img_box">
                                <img src="/img/upload/<?= $product_detail->image ?>"
                                    ...
                                    $.ajax(`http://cakephp.local:81/client/productDetails/product_details.json?id=${value}`, {
                                        ...
                                        console.log(arr.description)
                                            ...
                                            // console.log(obj.quantity)
                                                ...
                                                html += `<p class="price">¥${arr.price}</p>`
                                            // });
                                        ...
                                        $('#valiationSelect').on('change',function(){
                                            ...
                                            $.ajax(`http://cakephp.local:81/client/productDetails/product_details.json?id=${id}`, {
                                                ...
                                                success: function (data, status, xhr) {
                                                    let html = ""
                                                    arr1 = data.productDetail;
                                                    // arr1.forEach(obj => {
                                                        html += `<p class="price">¥${arr1.price}</p>`
                                                        if(arr1.quantity < 1){
                                                    $('.button_add').html(`<button type="submit" class="purchaseButton__btn purchaseButton__btn--outOfStock purchaseButton__btn--requestRestockMail x_restockMailNotificationModalOpen" disabled>Request restock notification</button>`)
                                                    $('.quantity_value').html('')
                                                }else{
                                    ...
                                    <select name="order_detail[product_detail_id]" id="valiationSelect" class="product_detail_id" data-display-stock="0">
                                        ...
                                        <option value="<?= $product_detail->id ?>" data-stock="0">
                                            <?php foreach($attributes as $attribute): ?>
                                                <?php foreach($product_detail->attribute_products as $attribute_product): ?>
                                                    <?php if($attribute->id == $attribute_product->attribute_id): ?>
